...
import com.example.swordcattest.feature_cat_listing.presentation.screens.components.CatAlertDialog
    ...
    Scaffold(
        ...
        Column(
            ...
            if (isSearching.value) {
                ...
                CatList(cats = cats.value, navController = navController, viewModel = viewModel)
            }
